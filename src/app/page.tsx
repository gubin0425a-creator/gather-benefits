'use client'; // App Router 프론트엔드 인터랙션 활성화
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredCoupons.map((coupon) => (
            ...
            >
              ...
              <h2 className={`text-lg font-bold mb-4 flex-grow line-clamp-2 ${coupon.isExpired ? 'text-gray-400 line-through' : 'text-gray-900'}`}>
                {coupon.title}
              </h2>
